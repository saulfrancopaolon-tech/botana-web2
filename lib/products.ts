...
export const PRODUCTS = [
  ...
  { id: 2,  name: "Cacahuate Jalapeño",   desc: "Cacahuates holandeses con el sabor clasico del chile jalapeño. El balance perfecto.",   price: 15, cat: "Cacahuates", tags: ["100g"], pop: false, spicy: true,  natural: false, emoji: "🥜", img: "/images/3.webp",  groupId: "cacahuates", flavor: "Jalapeño"  },
  ...
  { id: 9,  name: "Gomitas Gusano",       desc: "Gusanos de gomita enchilados sabor pepino. El snack acido-picoso que todos quieren.",   price: 15, cat: "Gomitas",    tags: ["100g"], pop: true,  spicy: true,  natural: false, emoji: "🪱", img: "/images/12.webp", groupId: "gomitas", flavor: "Gusano Diablo"},
  { id: 10, name: "Gomitas Pic-Ositos",   desc: "Ositos de gomita enchilados con chile. Un clasico mexicano.",                           price: 15, cat: "Gomitas",    tags: ["100g"], pop: true,  spicy: true,  natural: false, emoji: "🐻", img: "/images/11.webp", groupId: "gomitas", flavor: "Pic-Ositos"   },
  ...
  { id: 14, name: "Papas Fuego",          desc: "Papas con el maximo nivel de picante. Solo para los mas valientes.",                    price: 20, cat: "Papas",      tags: ["60g"], pop: true,  spicy: true,  natural: false, emoji: "🔥", img: "/images/15.webp", groupId: "papas", flavor: "Fuego"    },
  ...
  { id: 17, name: "Agua de Horchata",     desc: "Cremosa agua de horchata con canela. Dulce, fresca y reconfortante.",                  price: 22, cat: "Bebidas",    tags: ["500ml","Natural"], pop: false, spicy: false, natural: true,  emoji: "🥛", img: "/images/70.webp", groupId: "aguas", flavor: "Horchata" },
  ...
  { id: 18, name: "Chamoyada de Fresa",   desc: "Fresa natural con chamoy y chile. Dulce, acida y picante en cada sorbo.",             price: 30, cat: "Bebidas",    tags: ["Fresco","Frutal"], pop: true,  spicy: true,  natural: false, emoji: "🍓", img: "/images/69.webp", groupId: "chamoyadas", flavor: "Fresa"     },
  { id: 19, name: "Chamoyada de Limón",desc: "Limón con chamoy y chilito. El sabor mas mexicano en vaso.",                     price: 30, cat: "Bebidas",    tags: ["Fresco","Picante"], pop: false, spicy: true,  natural: false, emoji: "🟤", img: "/images/69.webp", groupId: "chamoyadas", flavor: "Tamarindo" },
]
...
export function buildGroups(products: Product[]): (Product | ProductGroup)[] {
  ...
  products.forEach(p => {
    ...
    seen.add(p.groupId)
    const grpProducts = grouped[p.groupId]
    if (grpProducts.length === 1) {
      result.push(grpProducts[0])
    } else {
      result.push({
        groupId: p.groupId,
        cat: p.cat,
        products: grpProducts,
        pop: grpProducts.some(x => x.pop),
      })
    }
  })
